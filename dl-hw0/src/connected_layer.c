...
void backward_connected_layer(layer l, matrix prev_delta)
{
    ...
    if(prev_delta.data){
        ...
        axpy_matrix(1.0, matmul(l.delta[0], transpose_matrix(l.w)), prev_delta);
    }
}
